...
BOARD_KERNEL_CMDLINE := androidboot.selinux=enforce androidboot.selinux=enforce loop.max_part=7
...
TARGET_KERNEL_CONFIG := r7_defconfig
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 71106560
